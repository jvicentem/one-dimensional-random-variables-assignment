...
$$ F(x) = \frac{x}{8} - \frac{x^2}{400} = 0.5 $$
```{r, warning=FALSE}
yacas("Solve((x/8)-(x^2/400) == 0.5, x)")
```

$$ x_{1} = - (200 · (\sqrt{\frac{68}{6400}} - \frac{1}{8}) = 4.384472$$
$$ x_{2} = - (-200 · (\sqrt{\frac{68}{6400}} + \frac{1}{8}) = 45.61553$$
...
http://halweb.uc3m.es/esp/Personal/personas/mwiper/docencia/Spanish/Introduction_to_Statistics/intro_variables2.pdf <- mediana