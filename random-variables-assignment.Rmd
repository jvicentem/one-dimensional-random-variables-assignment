...
Calculo el valor máximo de la función de densidad para hallar la moda:
...
Esto quiere decir que la función es decreciente para el intervalo $5 \leq x \leq 25$ (para el resto de valores, la función de densidad siempre devuelve 0), por lo que el máximo valor se encuentra en el extremo inferior de este intervalo, por lo que la moda es x = 5.
...
$$ x_{1} = - (200 · (\sqrt{\frac{512}{102400}} - \frac{1}{8}) = 10.85786$$
$$ x_{2} = - (-200 · (\sqrt{\frac{512}{102400}} + \frac{1}{8}) = 39.14214$$

Descartamos $x_{2}$ por ser un valor que no contenido en el intervalo, por lo que nos quedamos con el valor $x_{1}$.
